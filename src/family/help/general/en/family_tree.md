...
A family tree is built from two types of basic entities: **persons** and their **relations**.
...
- **ID** - Unique identifier
- **Partners** - List of **partners** in the relation (**partners** in a relation also have the **parent** role)
...
All parameters except **ID** are not unique, which means that there can be multiple relations with the same parameters and persons in **partners** and **children** lists. Also all parameters except **ID** can be empty.
